...
public:
    ...
    ord_coord(int _x, int _y, FLOAT _T)
    {
        x = _x;
        y = _y;
        T = _T;
...
inline bool operator < (const ord_coord &p, const ord_coord &q)
{
    return p.T>q.T;
}
...
public:
    ...
    {
        return mat2(a[0][0]-m.a[0][0], a[0][1]-m.a[0][1], a[1][0]-m.a[1][0], a[1][1]-m.a[1][1]);
    }
    inline mat2  operator + (const mat2 &m) const
    {
        return mat2(a[0][0]+m.a[0][0], a[0][1]+m.a[0][1], a[1][0]+m.a[1][0], a[1][1]+m.a[1][1]);
    ...
    inline mat2  operator * (const FLOAT &s) const
    {
    ...
    inline CImg<FLOAT> toImg() const
    {
        return CImg<FLOAT>::matrix(a[0][0], a[0][1], a[1][0], a[1][1]);
    }
};
